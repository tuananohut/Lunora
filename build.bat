...
cl -EHsc -FC -Zi ..\..\Lunora\Lunora\*.cpp ..\..\Lunora\Lunora\Core\Device\DeviceManager.cpp ..\..\Lunora\Lunora\Core\Pipeline\PipelineStateManager.cpp ..\..\Lunora\Lunora\Core\Resource\RenderTargetManager.cpp ..\..\Lunora\Lunora\Mesh\MeshData.cpp ..\..\Lunora\Lunora\Mesh\Terrain\TerrainMeshData.cpp user32.lib Gdi32.lib d3d11.lib d3dcompiler.lib dxgi.lib ..\data\resource.res 
