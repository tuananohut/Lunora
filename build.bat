...
cl -EHsc -FC -Zi /FeLunora.exe ..\..\Lunora\Lunora\Engine.cpp ..\..\Lunora\Lunora\Renderer.cpp ..\..\Lunora\Lunora\Camera\Camera.cpp user32.lib Gdi32.lib d3d11.lib d3dcompiler.lib dxgi.lib ..\data\resource.res
