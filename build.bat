...
cl -EHsc -FC -Zi /FeLunora.exe ..\..\Lunora\Lunora\Engine.cpp ..\..\Lunora\Triangle\Model.cpp ..\..\Lunora\Triangle\ColorShader.cpp user32.lib Gdi32.lib d3d11.lib d3dcompiler.lib dxgi.lib ..\data\resource.res
