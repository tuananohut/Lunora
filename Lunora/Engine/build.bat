...
set "cppFiles=c:\dev\Lunora\Lunora\Engine\src\test.cpp"
...
SET assembly=Engine
REM SET linkerFlags=user32.lib Gdi32.lib d3d11.lib d3dcompiler.lib dxgi.lib
...
cl /c /EHsc /Zi /FC /MDd -D_DEBUG -DLEXPORT -D_CRT_SECURE_NO_WARNINGS %cppFiles%
